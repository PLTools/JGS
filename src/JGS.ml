...
module HO = struct
  ...
  let rec substitute_typ subst q0 q30 =
    fresh q3 (q0 q3)
      (conde
         [
           fresh (typ q4) (q3 === !!(Array typ)) (q30 === !!(Array q4))
  ...
  and substitute_arg subst q34 q63 =
    fresh q37 (q34 q37)
      (conde
         [
           fresh (q38 index q39 q40)
             (q37 === !!(Type (var q38 index q39 q40)))
             (List.HO.nth subst (( === ) index) q63);
           fresh (typ q48) (q37 === !!(Type typ)) (q63 === !!(Type q48))
  ...
  struct
    let rec ( -<- ) ( <-< ) ta tb res =
      fresh (ta_val tb_val) (ta ta_val) (tb tb_val)
        (let ( <=< ) ta tb q97 =
         ...
         let capture_conversion id targs q205 =
           if need_simpified then
             fresh targs_val (targs targs_val) (q205 === !!(Some targs_val))
           else
             fresh q206 (targs q206)
               (let params q98 =
                ...
                let raw =
                  List.HO.mapi
                    (fun i q107 q133 ->
                      fresh (q134 q110) (i q134) (q107 q110)
                        (conde
                           [
                             fresh t (q110 === !!(Type t))
                               (q133 === !!(CC_type t));
                         ...
                         (conde
                            [
                              fresh (q194 q195 upb lwb)
                                (q193
                                === !!(Type (var q194 q195 upb !!(Some lwb))))
                                (( <-< ) (( === ) lwb) (( === ) upb) q192);
                              fresh () (q192 === !!true)
         ...
         let class_int_sub id_a targs_a id_b targs_b q235 =
           fresh (q232 q233 q208) (id_a q232) (id_b q233)
             (conde
                [
                ...
                [
                  fresh () (q208 === !!true)
                    (List.HO.fold_left2
                       ...
                       (( === ) !!true) targs_a targs_b q235);
                  fresh q211 (q208 === !!false)
                    ...
                    (conde
                       [
                         fresh
                           ...
                           (targs_b q217)
                           (List.HO.map (substitute_arg targs_a)
                              (( === ) targs_b') q218)
                           (conde
                              [
         ...
         fresh ()
           (conde
              [
                ...
                fresh (ta q310 q352 q353) (ta_val === !!(Array ta))
                  (ta === q352) (CT.HO.object_t q353)
                  (conde
                     [
                  ...
                  (conde
                     [
                       fresh (q318 q348 q329 q330) (q310 === !!true)
                         (q329 === tb_val) (CT.HO.object_t q330)
                         (conde
                            [
                         ...
                         (conde
                            [
                              ...
                              fresh () (q318 === !!false)
                                (conde
                                   [
                                     fresh tb (tb_val === !!(Array tb))
                                       (( -<- ) (( === ) ta) (( === ) tb) res);
                                     fresh q323 (tb_val === q323)
                                       (res === !!false)
                                       (tb_val =/= !!(Array __));
                                   ]);
                            ]);
                       fresh () (q310 === !!false)
                         (conde
                            [
                              fresh tb (tb_val === !!(Array tb))
                                (( -<- ) (( === ) ta) (( === ) tb) res);
                              fresh q315 (tb_val === q315) (res === !!false)
                                (tb_val =/= !!(Array __));
                            ]);
                     ]);
                fresh ts
                ...
                fresh q373 (ta_val === !!Null) (q373 === !!Null)
                  (conde
                     [
...
module FO = struct
  ...
  let substitute_typ q33 q32 q31 =
    substitute_typ (( === ) q33) (( === ) q32) q31

  let substitute_arg q66 q65 q64 =
    substitute_arg (( === ) q66) (( === ) q65) q64
    ...
    let ( -<- ) q383 q382 q381 q380 =
      ( -<- )
        (fun q387 q385 q384 ->
          call_fresh (fun q388 ->
              call_fresh (fun q386 ->
                  ?&[ q387 q388; q385 q386; q383 q388 q386 q384 ])))
        (( === ) q382) (( === ) q381) q380
  end
end
